...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome, please ask Alexa What is my universities caps number to get help"
...
class UniversityMHNumberIntentHandler(AbstractRequestHandler):
    def can_handle(self,handler_input):
        return ask_utils.is_intent_name("UniversityMHNumberIntent")(handler_input)
    
    def handle(self,handler_input):
        uni = handler_input.request_envelope.request.intent.slots['universities'].value
        chromeDriver = create_presigned_url("Media/chromedriver")
        phones = self.findNumber(uni,chromeDriver)
        speech_text = phones[0]
        handler_input.response_builder.speak(speech_text).set_should_end_session(False)
        return handler_input.response_builder.response
        
    def findNumber(self,university,cd):
        ...
        chrome_options.binary_location = os.getcwd() + "/bin/"+cd
